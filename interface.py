...
class Application:
    def __init__(self, master=None):
        ...
        ###############################
        self.dijk_v_fonteLabel = Label(self.dijk_v_fonteContainer, text="Dijkstra - Vertice Fonte: ",
        ...
        ##########################
        self.dijk_v_destinoLabel = Label(self.dijk_v_destinoContainer, text="Dijkstra - Vertice Destino: ",
                                         font=self.fontePadrao)
